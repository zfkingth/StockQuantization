                ...
                <ul>
                    ...
                    <li><button>常规筛选</button>
                        <ul>
                            ...
                            <li><button onClick={() => to('filterMiddleBreak')}> 中价突破</button></li>
                            <li><button onClick={() => to('filterUpwardGap')}> 向上跳空</button></li>
                            <li><button onClick={() => to('filterUpMATwice')}>二次突破</button></li>
                    ...
                    <li><button>量价形态</button>
                        <ul>
                            <li><button onClick={() => to('searchSTAArise')}> 统计涨幅</button></li>
                    ...
                    <li><button>帐户管理</button>
                        <ul>
                            ...
                            <li><button onClick={() => loadManage()}>用户管理</button></li>
